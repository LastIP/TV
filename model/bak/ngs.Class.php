...
ffmpeg -i e6724755dcab58b0cfe5ab0866f4bb71.mp4 -y -f image2 -ss 00:05:53 -vframes 1 -s 352x240 e6724755dcab58b0cfe5ab0866f4bb71.mp4.jpg
       ...
       $DB = SQL::Connect();
        ...
        $stmt->bind_result($ng_videoUrl, $ng_audioUrl, $ng_duration, $ng_courseLanguage, $ng_date, $ng_r2status);
            ...
            while ($stmt->fetch()) {
            	...
            	if ($ng_audioUrl != "") {	
            		//$json[$i]['ng_videoId'] = end(explode("/", $ng_videoUrl)); 	
            		$json[$i]['ng_audioId'] = $this->vidoesPath("url", $ng_audioUrl); 	
            	}
