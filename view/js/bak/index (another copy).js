var INDEX = {
	...
	static: `<div class="row">
		<div class="img col-6 col-md-2" onclick='MGLEMS.video("data/em/c67ce837b64a4bfcbcee2859516a96c1.mp4?response-content-type=application/octet-stream")'>
		<img src="data/em/c67ce837b64a4bfcbcee2859516a96c1.mp4.jpg" width="100%" class="img-fluid"><br>蒙语养生操</div>
		<div class="img col-6 col-md-2" onclick='MGLEMS.video("data/em/74619526753a8474c78d9acdd409f4c9.mp4?response-content-type=application/octet-stream")'>
		<img src="data/em/74619526753a8474c78d9acdd409f4c9.mp4.jpg" width="100%" class="img-fluid"><br>汉语养生操</div>

		<div class="img col-6 col-md-2" onclick='MGLEMS.video("data/em/8c124a5696464535fac84aa4de238820.mp4?response-content-type=application/octet-stream")'>
		<img src="data/em/8c124a5696464535fac84aa4de238820.mp4.jpg" width="100%" class="img-fluid"><br>讲座 (蒙语)</div>
		<div class="img col-6 col-md-2" onclick='MGLEMS.video("data/em/e8bdb9fa112a2b16065522a6e58dd656.mp4?response-content-type=application/octet-stream")'>
		<img src="data/em/e8bdb9fa112a2b16065522a6e58dd656.mp4.jpg" width="100%" class="img-fluid"><br>讲座 (蒙语)</div>
		<div class="img col-6 col-md-2" onclick='MGLEMS.video("data/em/20230327AM.mp4?response-content-type=application/octet-stream")'>
		<img src="data/em/20230327AM.mp4.jpg" width="100%" class="img-fluid"><br>20230327AM (汉语)</div>
		<div class="img col-6 col-md-2" onclick='MGLEMS.video("data/em/20230327PM.mp4?response-content-type=application/octet-stream")'>
		<img src="data/em/20230327PM.mp4.jpg" width="100%" class="img-fluid"><br>20230327PM (汉语)</div>


		<div class="img col-6 col-md-2" onclick='MGLEMS.video("data/em/1b2e6fcb098c9d1e4cd7b022db26fe3c.mp4?response-content-type=application/octet-stream")'>
		<img src="data/em/1b2e6fcb098c9d1e4cd7b022db26fe3c.mp4.jpg" width="100%" class="img-fluid"><br>blod</div>
		<div class="img col-6 col-md-2" onclick='MGLEMS.video("data/em/161262ce53f734c5007d43d837880fec.mp4?response-content-type=application/octet-stream")'>
		<img src="data/em/161262ce53f734c5007d43d837880fec.mp4.jpg" width="100%" class="img-fluid"><br>Bold - Heeriin Salhitai Ayalguu ft. Shuranhai</div>
	...
	statics: function (json){
		...
		for (var i = 0; i < json.length; i++) {
			console.log(json[i]);
			list =  `<div class="img col-6 col-md-2" onclick='MGLEMS.video("`+ json[i] +`.mp4?response-content-type=application/octet-stream")'><img src="`+ json[i] +`.mp4.jpg" width="100%" class="img-fluid"><br>`+ json[i] +`</div>` + list;
		}
