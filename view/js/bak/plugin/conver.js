	...
	if (document.getElementById('flexSwitch').checked === true) {
		QBLG.converText = QBLG.oldText;
			for (var i = 0; i < QBLG.hans.length; i++) {
				...
				QBLG.converText =  QBLG.converText.replaceAll(jian , zheng);
		  	}
	}


	document.getElementById('dynamic-modal-body').innerHTML = QBLG.converText + QLGTEXT.HTML('commentForm') + `<div id="qblg-modal-comments"></div>`;
	QLGTEXT.comments();
	QLGTEXT.encode();
...
*
*	简繁转换PHP
*	https://www.cnblogs.com/-mrl/p/9982820.html
*/
// var ZH = {};
